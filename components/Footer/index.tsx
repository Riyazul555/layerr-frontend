        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  ...
                  />
                  <Image
                    src="/images/logo/layerrdark.png"
                    alt="logo"
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Join us today and transform your data into actionable insights
                  with Layerr AI’s cutting-edge solutions.
                </p>
                <div className="flex items-center">
                  ...
                  {/* </a> */}
                  <a
                    href="https://www.linkedin.com/company/layerraiconsulting"
                    aria-label="social-link"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              <a href="https://nextjstemplates.com" rel="nofollow noopener"></a>
            </p>
          </div>
        </div>
